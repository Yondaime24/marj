<?php 
  ...
  $stmt = sql::con1()->prepare("SELECT * FROM feed_quote where quote_id=" . $_GET["quote_id"]);
  $stmt->execute();
  $res = $stmt->fetchAll();
...
<body>
  ...
  <main>
    ...
    <a class="btn btn-sm btn-success" href="addQuote.php" style="margin-bottom:10px;margin-left:10px;" title="Add Motivational Tips"><i style="font-size:16px;" class="fas fa-lightbulb"></i></a>
    ...
    <section class="sec-mid">
      ...
      <form method="post" id="form">
          ...
          <input type="hidden" name="quote_id" id="quote_id" value="<?php echo $res[0]['quote_id']; ?>">
...
<div class="modal fade" id="loaderModal" tabindex="-1">
  ...
  <script src="../assets/js/edit_quote.js"></script>
