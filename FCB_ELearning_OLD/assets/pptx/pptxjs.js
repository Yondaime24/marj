...
(function ($) {
    $.fn.pptxToHtml = function (options, ggf = undefined) {
        //var worker;
        var $result = $(this);
        ...
        $("#" + divId).prepend(
            $("<div></div>").attr({
                ...
                .html($("<div></div>").attr({
                    ...
                    "style": "width: 1%; background-color: green;"
        ...
        function updateProgressBar(percent) {
            ...
            //     SLIDE = null;
            //     setTimeout(function() {
            //         SLIDE = $('.pptx-file .slide');;
            //         SLIDE.hide();
            //         $('#pageno').html('');
            //         try {
            //             SLIDE[0].style.display = 'block';
            //             SLIDE[0].style.transition = '0.2s';
            //             SLIDE_HEIGHT = SLIDE[0].offsetHeight;
            //             SLIDE_LEN = SLIDE.length;
            //             GINDEX = 0;
            //             $('#pageno').html(1 + ' of ' + SLIDE_LEN); 
            //              UpdateWindow();
