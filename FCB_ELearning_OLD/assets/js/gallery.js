  ...
  (e.extend = t),
    ...
    t(e.prototype, {
      ...
      removeClass: function (t) {
        for (
          var e, i = new RegExp("(^|\\s+)" + t + "(\\s+|$)"), s = this.length;
          s;
      ...
      off: function (t, e) {
        for (var i, s, n = t.split(/\s+/); n.length; )
          for (t = n.shift(), i = this.length; i; )
            (s = this[(i -= 1)]).removeEventListener
        ...
        ontouchend: function (t) {
          ...
          var e,
            ...
            d =
              ...
              Math.abs(this.touchDelta.x) > l / 2,
            c =
          ...
          this.options.continuous && (c = !1),
            ...
            this.isScrolling
              ...
              ? ((i = a + e),
                ...
                this.move(a, this.positions[a] + n, r),
                this.move(
                  this.circle(s),
                ...
                this.onslide(a))
              : this.options.continuous
              ? (this.move(this.circle(a - 1), -l, r),
                this.move(a, 0, r),
                this.move(this.circle(a + 1), l, r))
              : (a && this.move(a - 1, -l, r),
                this.move(a, 0, r),
                a < this.num - 1 && this.move(a + 1, l, r));
        },
        ...
        imageFactory: function (e, i) {
          ...
          return (
            "string" != typeof d &&
              ...
              (r = this.getItemProperty(e, this.options.altTextProperty) || a)),
            !0 === c && (c = "contain"),
            (c =
              ...
              (s || t(m))
                ...
                .on("pause", function () {
                  m.seeking ||
                    ...
                    l && h.container.addClass(h.options.controlsClass),
